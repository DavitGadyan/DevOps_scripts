...
st.title('Semtiment Analysis of Tweets')
st.sidebar.title('Semtiment Analysis of Tweets')
...
def load_data():
    ...
    data['tweet_created'] =data.dropna(subset=['tweet_created'])
...
random_tweet = st.sidebar.radio('Semtiment', ('positive', 'neutral', 'positive'))
...
if not st.sidebar.checkbox('Cloise', True, key='1'):
